...
#define PIX_H 1 // number of rows
#define PIX_W 5 // number of columns
...
int main(void) {
	...
	while (fpga[R_WPU_STATUS] > 0) {};
	// In the one shot mode we'll just wait for everything.
	//
